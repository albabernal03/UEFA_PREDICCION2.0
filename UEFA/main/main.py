...
modelos_indices_celda = {
    os.path.normpath("../modelos/Aprendizaje por refuerzo/cadenas_markov.ipynb"): 8,
    os.path.normpath("../modelos/modelo2.ipynb"): 1,
    os.path.normpath("../modelos/modelo3.ipynb"): 2,
...
if opcion.isdigit() and 1 <= int(opcion) <= len(notebooks_encontrados):
    ...
    # Normalizar la ruta del modelo seleccionado
    notebook_seleccionado_normalizado = os.path.normpath(notebook_seleccionado)
    
    # Obtener el índice de celda asociado al modelo seleccionado
    indice_celda = modelos_indices_celda.get(notebook_seleccionado_normalizado)
